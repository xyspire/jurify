        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8">
          <div className="max-w-2xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-[#0f172a] font-medium text-sm tracking-wide">Our Team</span>
            </div>
          ...
          <div className="max-w-md flex flex-col items-start lg:items-end gap-6 lg:gap-8">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden md:flex gap-2">
                ...
                >
                  <ChevronLeft className="w-5 h-5 text-[#0f172a] group-hover:-translate-x-0.5 transition-transform" />
                </button>
                <button 
                  onClick={scrollRight}
                  className="w-12 h-12 flex items-center justify-center border border-slate-200 hover:bg-slate-50 transition-colors group"
                ...
                >
                  <ChevronRight className="w-5 h-5 text-[#0f172a] group-hover:translate-x-0.5 transition-transform" />
                </button>
              </div>
              <button className="hidden md:flex bg-[#112a75] text-white px-6 py-3 md:px-8 md:h-12 font-semibold text-sm md:text-base items-center justify-center gap-3 hover:bg-[#0c1f56] transition-colors">
                View All Members
          ...
          {teamMembers.map((member, index) => (
            <div key={index} className="flex-none w-[85vw] sm:w-[60vw] md:w-[40vw] lg:w-[30vw] snap-center group relative aspect-[3/4] md:aspect-[4/5] overflow-hidden bg-black flex flex-col justify-end cursor-pointer">
              ...
              <div className="absolute top-4 right-4 md:top-6 md:right-6 w-8 h-8 md:w-10 md:h-10 bg-white flex items-center justify-center z-20">
                <Plus className="w-5 h-5 md:w-6 md:h-6 text-[#112a75]" />
              </div>
